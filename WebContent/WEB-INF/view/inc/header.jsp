...
<header id="header">
	<div class="content-container">
		<h1 id="logo">
			<a href="${path}/customer/notice-list"><img
				src="${path}/images/logo.png" alt="뉴렉처사이트" /></a>
		</h1>
		...
		<section>
			...
			<nav id="custom-menu" class="hr-list customer-menu">
				...
				<ul>
					<li><a href="${path}/member/home"><img
							src="${path}/images/txt-mypage.png" alt="마이페이지" /></a></li>
					<li><a href="${path}/customer/notice/list"><img
							src="${path}/images/txt-customer.png" alt="고객센터" /></a></li>
				</ul>
			</nav>
